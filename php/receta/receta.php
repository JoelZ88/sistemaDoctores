                ...
                <div class="card card-body">
                    ...
                    onsubmit="return ingresar();">
                        ...
                        <div class="form-group">
                            <input type="text" id="id_paciente" name="id_paciente" class="form-control" placeholder="No de control del paciente" autofocus
                            pattern="[0-9]{1,9}" title="Solo se aceptan numeros">
                            <input type="text" id="paciente" name="paciente" class="form-control" placeholder="Nombre del paciente" autofocus
                            required pattern="[A-Za-z ]{5,40}" title="Solo se aceptan letras">
                        </div>

                        <div class="form-group">
                            <input type="text" id="edad" name="edad" class="form-control" placeholder="Edad del paciente" autofocus
                            required pattern="[0-9]{1,3}" title="Solo se aceptan numeros">
                            ...
                            <input type="text" id="ta" name="ta" class="form-control" placeholder="Tension arterial " 
                            autofocus required pattern="[0123456789/]{5,6}" title="por ejemplo 180/80 ">

                            <input type="text" id="fe" name="fe" class="form-control" placeholder="Frecuencia Cardiaca" autofocus 
                            required pattern="[0123456789]{0,6}" title="solo numeros">
                        ...
                        <input type="submit" class="btn btn-success btn-block" name="boton" value="Guardar Receta">
                ...
                <table class="table table-bordered" >
                    ...
                    <tbody>
                        <?php 
                            ...
                            $query = "SELECT * FROM receta where id_doctor = '$id' 
                            ...
                            while($fila = mysqli_fetch_array($resultado)){?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="modificarReceta.php?id=<?php echo $fila['id_receta'];?>" class="btn btn-secondary">
                                        <i class="fas fa-marker"></i>
                                        </a>
                                        <a href="eliminarReceta.php?id=<?php echo $fila['id_receta'];?>" class="btn btn-danger">
                                            <i class="far fa-trash-alt"></i>
                                        </a>
                                        <a href="pdfReceta.php?id=<?php echo $fila['id_receta'];?>">Ver</a>
                                    </td> 
                                </tr>
